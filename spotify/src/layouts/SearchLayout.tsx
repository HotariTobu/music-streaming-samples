...
const searchTypes = [
  { path: "/search/tracks", label: "Tracks", icon: <Music className="h-4 w-4" /> },
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <Button
          ...
          className="h-12 px-6 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white"
        >
          Search
        </Button>
      </div>
