...
const searchTypes = [
  { path: "/search/videos", label: "Videos", icon: <Music className="h-4 w-4" /> },
  { path: "/search/channels", label: "Channels", icon: <Mic2 className="h-4 w-4" /> },
    ...
    <div className="space-y-4">
      ...
      {!urlQuery && (
        <div className="text-center py-12 text-muted-foreground">
          ...
          <p>Search for videos, channels, or playlists</p>
        </div>
      )}
    </div>
  );
