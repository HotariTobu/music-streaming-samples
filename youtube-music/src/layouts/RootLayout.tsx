...
const navItems: {
  ...
  { to: "/search/videos", label: "Search", icon: <Search className="h-4 w-4" /> },
  {
...
export function RootLayout() {
  const { isConfigured, isReady, isAuthorized, error, authorize, logout, checkCredentials } =
    useYouTube();
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Enter your Google Cloud credentials to get started
            </p>
          </div>
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Initializing YouTube Player...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link to="/search/videos" className="flex items-center gap-3">
              <Youtube className="h-6 w-6 text-red-500" />
              <div>
                <h1 className="font-bold text-lg">YouTube Music API</h1>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`w-2 h-2 rounded-full ${isAuthorized ? "bg-green-500" : "bg-amber-500"}`}
                />
            ...
            <div className="flex flex-wrap gap-4 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">
                  Library, Playlists, Subscriptions
                </span>
              </div>
              <div className="flex items-center gap-2">
      ...
      <footer className="border-t border-border py-6 mt-8">
        <div className="max-w-6xl mx-auto px-4 text-center text-muted-foreground text-sm">
          <p>YouTube Music API Sample with YouTube Data API v3</p>
          <p className="mt-1">
            <a
